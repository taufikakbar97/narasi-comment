...
let ArticleController = class ArticleController {
    ...
    async update(id, body) {
        const newArticle = await this.articleService.update(id, body);
    ...
    async findAllByUserid(userId) {
        const articles = await this.articleService.findAllByuserId(userId);
        return articles;
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ArticleController.prototype, "findAllByUserid", null);
